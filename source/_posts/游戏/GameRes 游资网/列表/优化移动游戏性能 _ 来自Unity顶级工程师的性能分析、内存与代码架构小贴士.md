...
<br>
<div class="blockcode"><div id="code_YlU"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_YlU'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_tgc"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_tgc'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_x1F"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_x1F'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_eYM'));">复制代码</em></div><br>
