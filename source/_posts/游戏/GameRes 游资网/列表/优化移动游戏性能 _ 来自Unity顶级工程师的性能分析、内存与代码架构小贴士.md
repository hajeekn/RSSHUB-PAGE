...
<br>
<div class="blockcode"><div id="code_l5P"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_l5P'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_WXN"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_WXN'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_sAx"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_sAx'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_uFN'));">复制代码</em></div><br>
