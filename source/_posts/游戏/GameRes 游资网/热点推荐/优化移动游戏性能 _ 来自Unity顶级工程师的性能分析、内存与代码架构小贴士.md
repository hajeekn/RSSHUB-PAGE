...
<br>
<div class="blockcode"><div id="code_q5y"><ol><li>private int interval = 3;<br>
</li><li><br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_q5y'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_s0p"><ol><li>#if UNITY_EDITOR<br>
</li><li>void Update()<br>
</li><li>&#123;<br>
</li><li>&#125;<br>
</li><li>#endif</li></ol></div><em onclick="copycode($('code_s0p'));">复制代码</em></div><br>
...
<br>
<div class="blockcode"><div id="code_IC5"><ol><li>public static class Logging<br>
</li><li>&#123;<br>
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_IC5'));">复制代码</em></div><br>
<div align="center">
...
</li><li>&#125;</li></ol></div><em onclick="copycode($('code_QL0'));">复制代码</em></div><br>
