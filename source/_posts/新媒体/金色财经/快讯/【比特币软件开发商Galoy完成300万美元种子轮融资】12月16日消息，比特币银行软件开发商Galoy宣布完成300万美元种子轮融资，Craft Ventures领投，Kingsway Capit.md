...
---
title: '【比特币软件开发商Galoy完成300万美元种子轮融资】12月16日消息，比特币银行软件开发商Galoy宣布完成300万美元种子轮融资，Craft Ventures领投，Kingsway Capit...'
categories: 
 - 新媒体
 - 金色财经
 - 快讯
...
Galoy的技术堆栈包括用于发布比特币银行的全面功能：安全后端API、移动钱包、销售点应用程序、合规工具和管理控制。Galoy还为那些寻求完全管理实现和支持的人提供托管的“银行即服务”（Banking-as-a-Service）解决方案。完整的代码库是开源的，所有人都可以在GitHub上查看、审计和使用。（PR Newswire）  
</div>
