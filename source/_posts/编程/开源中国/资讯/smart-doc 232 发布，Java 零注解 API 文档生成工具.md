...
---
title: 'smart-doc 2.3.2 发布，Java 零注解 API 文档生成工具'
categories: 
 - 编程
 - 开源中国
 - 资讯
...
<ul> 
 <li>修复debug调试页搜索后目录锚点错误。</li> 
 <li>修复生成openapi时List等基本类型数组入参时类型转换错误。</li> 
 <li>优化泛型类型显示，当泛型类型的实参类型是基本类型时直接显示为基本类型。</li> 
 <li>新增对@RequestAttribute参数的忽略。</li> 
 <li>修复@RequstBody使用基本类型时的请求参数示例错误。</li> 
</ul> 
<p> </p> 
...
<p style="color:#333333; margin-left:0; margin-right:0; text-align:left"><img alt="smart-doc+torna" src="https://gitee.com/smart-doc-team/smart-doc/raw/master/images/smart-doc-torna.png" referrerpolicy="no-referrer"></p> 
<p style="color:#333333; margin-left:0; margin-right:0; text-align:left"><a href="https://gitee.com/smart-doc-team/smart-doc/wikis/smart-doc%E4%B8%8Etorna%E5%AF%B9%E6%8E%A5?sort_id=3695028">smart-doc+Torna文档自动化</a></p> 
...
<p style="color:#333333; margin-left:0; margin-right:0; text-align:left"><a href="https://www.oschina.net/action/GoToLink?url=https%3A%2F%2Fgithub.com%2Fshalousun%2Fapi-doc-test.git" target="_blank">使用demo</a>轻松玩转接口文档生成，其他用户案例文档效果展示：https://api.doubans.com/</p> 
...
<p style="color:#333333; margin-left:0; margin-right:0; text-align:left">在今年8月 smart-doc 也新增了一些外海的用户。</p> 
<h1 style="margin-left:0; margin-right:0; text-align:left">鸣谢</h1> 
<p style="color:#333333; margin-left:0; margin-right:0; text-align:left">smart-doc 也是利用一些开源技术构建起来的，我在这里对下列开源项目表示感谢。</p> 
<ul style="list-style-type:disc; margin-left:0; margin-right:0"> 
 <li> <p style="margin-left:0; margin-right:0; text-align:start">Beetl 国内开源的JAVA模板引擎</p> </li> 
