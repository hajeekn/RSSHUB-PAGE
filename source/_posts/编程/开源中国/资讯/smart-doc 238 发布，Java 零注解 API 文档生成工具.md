...
---
title: 'smart-doc 2.3.8 发布，Java 零注解 API 文档生成工具'
categories: 
 - 编程
 - 开源中国
 - 资讯
...
<ol style="list-style-type:decimal; margin-left:0; margin-right:0"> 
 <li> <span style="background-color:#ffffff; color:#40485b">支持泛型多层继承解析</span></li> 
 <li> <span style="background-color:#ffffff; color:#40485b">优化生成postman post请求文档</span>。</li> 
 <li> 完善JAX-RS规范支持。</li> 
</ol> 
