...
---
title: 'MT-AUTH v1.3.0 发布，基于 RBAC 的权限系统'
categories: 
 - 编程
 - 开源中国
 - 资讯
...
author: 开源中国
comments: false
date: Sun, 20 Mar 2022 02:14:00 GMT
...
<ul> 
 ...
 <li>共享API相关页面改动</li> 
 <li>减少页面载入API请求数目</li> 
 <li>管理员页面client api改进</li> 
 <li>依据权限动态显示租户页面</li> 
</ul> 
<h2 style="text-align:start">mt-integration-test</h2> 
<ul> 
 <li>修复测试</li> 
</ul> 
<p> </p>
