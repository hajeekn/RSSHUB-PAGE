...
---
title: 'PHP 开源工作流引擎 Tpflow V6.0.1 正式版发布'
categories: 
 - 编程
 - 开源中国
 - 资讯
...
author: 开源中国
comments: false
date: Wed, 26 Jan 2022 00:50:00 GMT
...
<h3 style="margin-left:0; margin-right:0; text-align:start"><strong>关于6.0.1 版本更新内容</strong></h3> 
<ul style="list-style-type:disc; margin-left:0; margin-right:0"> 
 ...
 <li> <p><span style="background-color:#ffffff; color:#333333">【优化】</span>重新调整逻辑检查</p> </li> 
 <li> <p> </p> <p><span style="background-color:#ffffff; color:#333333">【增加】</span>增加获取单据注释的方法</p> <p><span style="background-color:#ffffff; color:#333333">【增加】</span>增加node-msg消息节点事件</p> </li> 
</ul> 
