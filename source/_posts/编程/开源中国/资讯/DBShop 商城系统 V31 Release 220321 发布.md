...
---
title: 'DBShop 商城系统 V3.1 Release 220321 发布'
categories: 
 - 编程
 - 开源中国
 - 资讯
...
author: 开源中国
comments: false
date: Mon, 21 Mar 2022 06:44:00 GMT
...
<div class="content">
 ...
 <div> 
  <div style="text-align:left"> 
   ...
   <ul> 
    <li style="text-align:start">新增 客户注册登录的复杂密码功能设置</li> 
    <li style="text-align:start">新增 前台找回密码可设置站外url</li> 
    <li style="text-align:start">优化 后台客户列表显示客户数量</li> 
    <li style="text-align:start">优化 前台订单结算页面积分使用</li> 
    <li style="text-align:start">优化 后台订单详情，如果是提货信息，加入购买人和购买人电话显示</li> 
    <li style="text-align:start">优化 插件封面切换为cdn图片</li> 
    <li style="text-align:start">优化 前台找回密码判断相关设置是否启用</li> 
    <li style="text-align:start">优化 阿里云短信发送优化</li> 
    <li style="text-align:start">优化 安全加固</li> 
    <li style="text-align:start">优化 后台广告文字添加，用于需要显示文字的广告模板</li> 
    <li style="text-align:start">优化 打印订单提货人信息添加</li> 
    <li style="text-align:start">优化 冗余代码优化</li> 
   </ul> 
   ...
   <p style="color:#333333; margin-left:0; margin-right:0; text-align:start"><strong>下载地址：<a href="https://www.oschina.net/action/GoToLink?url=https%3A%2F%2Fdownload.loongdom.com.cn%2Fdbshop%2FV3.1%2FDBShopV3.1_Release220321.tar.gz" target="_blank"><span> </span>https://download.loongdom.com.cn/dbshop/V3.1/DBShopV3.1_Release220321.tar.gz</a></strong></p> 
  </div> 
 </div> 
</div> 
<div style="text-align:start"> 
 <div> 
  ...
  <div> 
   <ul style="margin-left:0; margin-right:0"> 
    <li>DBShop 的详细介绍：<a href="https://www.oschina.net/p/dbshop" target="_blank">点击查看</a></li> 
    <li>DBShop 的下载地址：<a href="https://www.oschina.net/action/GoToLink?url=http%3A%2F%2Fwww.dbshop.net%2F" target="_blank">点击下载</a></li> 
   </ul> 
  </div> 
 </div> 
</div>
