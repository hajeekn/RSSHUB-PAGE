...
---
title: 'sagacity-sqltoy-5.1.17、4.19.8 发版，缓存翻译增加注解功能'
categories: 
 - 编程
 - 开源中国
 - 资讯
...
author: 开源中国
comments: false
date: Fri, 19 Nov 2021 02:15:00 GMT
...
<div class="content">
                                                        ...
                                                        <p style="color:#333333; margin-left:0; margin-right:0; text-align:left"><strong>致谢：</strong>感谢支持sqltoy的发展的用户，感谢大家给予的反馈！</p> 
...
<div style="text-align:left"> 
 <p>1、增加 @ Translate 缓存翻译注解<br> ```java<br> /**<br>  * 购销类型名称<br>  */<br> @Translate(cacheName="dictKeyName", cacheType = "PURCHASE_SALE_TYPE",keyField = "psType")<br> private String psTypeName;</p> 
 <p>/**<br>  * 员工姓名<br>  */<br> @Translate(cacheName="staffIdName", keyField = "staffId")<br> private String staffName;<br> ```<br> 2、使用缓存翻译时缓存名称匹配忽略大小写，增强书写容错性</p> 
</div> 
<div style="text-align:left">
  
</div> 
